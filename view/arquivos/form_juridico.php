...
<form method="POST" action="../router.php?controller=ClienteJuridico&modo=cadastrar" id="juridico">
	...
	<div class="linha_cadastro_usuario">
		<input class="campo_cadastro_usuario" type="text" name="txtRazao" required onkeypress="return validar(event,'number')">
	</div>
	...
	<div class="linha_cadastro_usuario">
		<input class="campo_cadastro_usuario txtlogradouro" type="text" name="txtLogradouro">
	</div>
