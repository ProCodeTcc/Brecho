...
<div class="caixa_categoria">
	<div class="categoria_pesquisa">
		...
		<div class="categoria">
			...
			<div class="categoria_linha filtrar" onClick="filtrarClassificacao('A', <?php echo($idSubcategoria) ?>)">
				A
			</div>
			<div class="categoria_linha filtrar" onClick="filtrarClassificacao('B', <?php echo($idSubcategoria) ?>)">
				B
			</div>
			<div class="categoria_linha filtrar" onClick="filtrarClassificacao('C', <?php echo($idSubcategoria) ?>)">
				C
			</div>
			...
			<div class="categoria_tamanhos container_tamanho">
				...
				<div class="tamanhos" onClick="filtrarTamanho(<?php echo($rsMedidas[$cont]->getId()) ?>, <?php echo($idSubcategoria) ?>)">
			...
			<div class="categoria_tamanhos container_tamanho">
				...
				<div class="tamanhos" onClick="filtrarTamanho(<?php echo($rsNumeros[$cont]->getId()) ?>, <?php echo($idSubcategoria) ?>)">
			...
			?>
				<div class="cores" style="background-color: <?php echo($rsCor[$cont]->getCor()) ?>;" onclick="filtrarCor(<?php echo($rsCor[$cont]->getId()) ?>, <?php echo($idSubcategoria) ?>)">
					<span class="nome_cor">
		...
		?>
			<div class="categoria_linha filtrar" onClick="filtrarMarca(<?php echo($rsMarca[$cont]->getId()) ?>, <?php echo($idSubcategoria) ?>)">
				<?php
		...
		<div class="filtro_categoria">
			<?php
				...
				if($tipoFiltro == 'classificacao'){
					$rsFiltro = $listCategoria->listarSubcategoriaClassificacao($idSubcategoria, $filtro, $pesquisa);
				}else if($tipoFiltro == 'tamanho'){
					$rsFiltro = $listCategoria->listarSubcategoriaTamanho($idSubcategoria, $filtro, $pesquisa);
				}else if($tipoFiltro == 'cor'){
					$rsFiltro = $listCategoria->listarSubcategoriaCor($idSubcategoria, $filtro, $pesquisa);
				}else if($tipoFiltro == 'marca'){
					$rsFiltro = $listCategoria->listarSubcategoriaMarca($idSubcategoria, $filtro, $pesquisa);
				}
