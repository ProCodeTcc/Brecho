<?php
    class SubcategoriaDAO{
		...
		public function SelectByClassificacaoTranslate($idSubcategoria, $classificacao, $pesquisa){
			//instância da classe de conexão com o banco de dados
			$conexao = new ConexaoMySQL();
        ...
        //função para pegar um produto pelo tamanho
        ...
        //função para pegar um produto pelo tamanho em inglês
        public function SelectByTamanhoTranslate($idSubcategoria, $tamanho, $pesquisa){
			//instância da classe de conexão com o banco
			$conexao = new ConexaoMySQL();
			...
			//query que faz a consulta
			$stm = $PDO_conexao->prepare('SELECT pt.nomeProduto as nome, t.tamanho, c.nome as cor, m.nomeMarca as marca, p.preco, p.descricao, p.idProduto, f.caminhoImagem as imagem FROM produto_traducao as pt INNER JOIN produto as p ON pt.idProduto = p.idProduto INNER JOIN tamanho AS t ON t.idTamanho = p.idTamanho INNER JOIN produto_fotoproduto as pf ON p.idProduto = pf.idProduto INNER JOIN fotoproduto AS f ON f.idImagemProduto = pf.idImagemProduto INNER JOIN corroupa as c ON c.idCor = p.idCor INNER JOIN marca as m ON m.idMarca = p.idMarca WHERE p.status = 1 AND p.idSubcategoria = ? AND p.idTamanho = ? AND p.nomeProduto LIKE ? GROUP BY p.idProduto');
        ...
        //função para pegar um produto pela cor
        ...
        //função para pegar um produto pela cor em inglês
        public function selectByCorTranslate($idSubcategoria, $cor, $pesquisa){
			//instância da classe de conexão com o banco
			$conexao = new ConexaoMySQL();
			...
			//query que busca os dados
			$stm = $PDO_conexao->prepare('SELECT pt.nomeProduto, t.tamanho, c.nome as cor, m.nomeMarca as marca, p.preco, p.descricao, p.idProduto, f.caminhoImagem as imagem FROM produto_traducao as pt INNER JOIN produto as p ON pt.idProduto = p.idProduto INNER JOIN tamanho AS t ON t.idTamanho = p.idTamanho INNER JOIN produto_fotoproduto as pf ON p.idProduto = pf.idProduto INNER JOIN fotoproduto AS f ON f.idImagemProduto = pf.idImagemProduto INNER JOIN corroupa as c ON c.idCor = p.idCor INNER JOIN marca as m ON m.idMarca = p.idMarca WHERE p.status = 1 AND p.idSubcategoria = ? AND p.idCor = ? AND p.nomeProduto LIKE ? GROUP BY p.idProduto');
		...
		public function selectByMarcaTranslate($idSubcategoria, $marca, $pesquisa){
			//instância da classe de conexão com o banco
			$conexao = new ConexaoMySQL();
			...
			//query que busca os dados
			$stm = $PDO_conexao->prepare('SELECT pt.nomeProduto, t.tamanho, c.nome as cor, m.nomeMarca as marca, p.preco, p.descricao, p.idProduto, f.caminhoImagem as imagem FROM produto_traducao as pt INNER JOIN produto as p ON pt.idProduto = p.idProduto INNER JOIN tamanho AS t ON t.idTamanho = p.idTamanho INNER JOIN produto_fotoproduto as pf ON p.idProduto = pf.idProduto INNER JOIN fotoproduto AS f ON f.idImagemProduto = pf.idImagemProduto INNER JOIN corroupa as c ON c.idCor = p.idCor INNER JOIN marca as m ON m.idMarca = p.idMarca WHERE p.status = 1 AND p.idSubcategoria = ? AND p.idMarca = ? AND p.nomeProduto LIKE ? GROUP BY p.idProduto');
        ...
        //função para selecionar o produto pelo preço e subcategoria em inglês
        public function selectByPrecoTranslate($pesquisa, $min, $max, $idSubcategoria){
            //instância da classe de conexão com o banco
            $conexao = new ConexaoMySQL();
            ...
            //query que busca os dados
			$stm = $PDO_conexao->prepare('SELECT pt.nomeProduto as nome, t.tamanho, c.nome as cor, m.nomeMarca as marca, p.preco, p.descricao, p.idProduto, f.caminhoImagem as imagem FROM produto_traducao as pt INNER JOIN produto as p ON pt.idProduto = p.idProduto INNER JOIN tamanho AS t ON t.idTamanho = p.idTamanho INNER JOIN produto_fotoproduto as pf ON p.idProduto = pf.idProduto INNER JOIN fotoproduto AS f ON f.idImagemProduto = pf.idImagemProduto INNER JOIN corroupa as c ON c.idCor = p.idCor INNER JOIN marca as m ON m.idMarca = p.idMarca WHERE p.status = 1 and p.idSubcategoria = ? and p.nomeProduto LIKE ? and p.preco >= ? and p.preco <= ? GROUP BY p.idProduto');
